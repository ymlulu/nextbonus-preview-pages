(() => {
  ...
  document.addEventListener('nb:product-detail-mounted',queueEnhance);
  window.addEventListener('nb:offer-overlay-history',queueEnhance);
  window.addEventListener('popstate',queueEnhance);

  window.NextBonusNavigationEnhancements = Object.freeze({refresh:enhance});
})();
