(() => {
  ...
  // Current Offer facts. This is the only layer that owns changing value / requirement / status / tag selections.
  const OFFERS = Object.freeze({
    'chase-sapphire': {productId:'chase-sapphire', primaryValue:'75,000 UR', primaryRequirement:'3 个月内消费 $4,000', statusTag:null, valueTag:'high_bonus', attributeTag:'travel_card'},
    'amex-gold': {productId:'amex-gold', primaryValue:'100,000 MR', primaryRequirement:'6 个月内消费 $6,000', statusTag:'new_offer', valueTag:'high_bonus', attributeTag:'dining_card'},
    'amex-platinum': {productId:'amex-platinum', primaryValue:'最高 175,000 MR', primaryRequirement:'6 个月内消费 $12,000', statusTag:'new_offer', valueTag:'high_bonus', attributeTag:'travel_card'},
    'bilt-palladium': {productId:'bilt-palladium', primaryValue:'50,000 points + $300 Bilt Cash', primaryRequirement:'3 个月内消费 $4,000', statusTag:null, valueTag:'high_bonus', attributeTag:'everyday'},
    'capitalone-venturex': {productId:'capitalone-venturex', primaryValue:'75,000 miles', primaryRequirement:'3 个月内消费 $4,000', statusTag:null, valueTag:'high_bonus', attributeTag:'travel_card'},
    'citi-strata': {productId:'citi-strata', primaryValue:'75,000 TYP', primaryRequirement:'3 个月内消费 $6,000', statusTag:null, valueTag:'high_bonus', attributeTag:'travel_card'},
    ...
    'cashback-deal': {productId:'cashback-deal', primaryValue:'最高 100% 返现', primaryRequirement:'仅限符合条件的新用户', statusTag:'ends_today', valueTag:'high_cashback', attributeTag:'limited'},
