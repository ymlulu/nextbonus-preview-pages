(() => {
  ...
  function usbankPanel(saved){
    return `
      <div class="nb-bank-head"><div class="nb-bank-brand"><div class="nb-bank-mark">US</div><div><strong>US Bank</strong><small>Smartly Checking</small></div></div><button class="nb-bank-save ${saved?'saved':''}" data-action="bookmark" data-id="usbank-checking">♡ ${saved?'已关注':'关注'}</button></div>
      ...
      <a class="nb-bank-cta" href="https://www.uscreditcards101.com/go/usbank-checking" target="_blank" rel="noopener noreferrer">立即开户 <span>↗</span></a><div class="nb-bank-deadline">当前活动截止：2026 年 11 月 10 日</div>
  ...
  function moomooPanel(saved){
    return `<div class="mm-head"><div class="mm-head-brand"><div class="mark">M</div><div><strong>Moomoo</strong><small>Invest Smarter</small></div></div><button class="mm-save ${saved?'saved':''}" data-action="bookmark" data-id="moomoo">♡ ${saved?'已关注':'关注'}</button></div>
    ...
    <a class="mm-cta" href="https://www.uscreditcards101.com/go/moomoo" target="_blank" rel="noopener noreferrer">立即开户 <span>↗</span></a><div class="mm-deadline">本站专属 $150 活动：2026 年 9 月 30 日前完成累计入金</div><details class="mm-eligibility"><summary>申请前请确认资格要求</summary><div class="mm-eligibility-copy"><div>需要 SSN 或 ITIN，并使用美国地址申请。</div><div>本站专属 $150 股票卡仅适用于符合活动条件的新用户，并需通过本站专属链接注册。</div><div>入金后交易产生亏损可能导致资产低于奖励门槛，建议保留一定余量。</div></div></details>`;
  }
