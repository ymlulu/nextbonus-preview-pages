(() => {
  ...
  window.NextBonusPageRegistry.register('products',function(ctx){
    ...
    return `<div class="content products-page v4-products-page">
      <div class="v4-products-head"><div><h1>钱包</h1></div><button class="mock-add-btn v4-add-product" data-action="open-add-product" aria-label="添加产品">+<span class="v4-add-product-label">添加</span></button></div>
